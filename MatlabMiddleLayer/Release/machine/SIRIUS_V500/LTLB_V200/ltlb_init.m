...
AO.bn.Monitor.ChannelNames = getname(AO.bn.FamilyName, 'Monitor', AO.bn.DeviceList);
AO.bn.Monitor.HW2PhysicsParams = 1;
AO.bn.Monitor.Physics2HWParams = 1;
...
AO.bn.Setpoint.ChannelNames = getname(AO.bn.FamilyName, 'Setpoint', AO.bn.DeviceList);
AO.bn.Setpoint.HW2PhysicsParams = 1;
AO.bn.Setpoint.Physics2HWParams = 1;
...
AO.qa1.DeviceList  = getDeviceList(1,2);
...
AO.qe1.FamilyName  = 'qe1';
AO.qe1.MemberOf    = {'PlotFamily'; 'qe1'; 'QUAD'; 'Magnet';};
AO.qe1.DeviceList  = getDeviceList(1,1);
AO.qe1.ElementList = (1:size(AO.qe1.DeviceList,1))';
AO.qe1.Status      = ones(size(AO.qe1.DeviceList,1),1);
AO.qe1.Position    = [];
AO.qe1.Monitor.MemberOf = {};
AO.qe1.Monitor.Mode = 'Simulator';
AO.qe1.Monitor.DataType = 'Scalar';
AO.qe1.Monitor.Units        = 'Hardware';
AO.qe1.Monitor.HWUnits      = 'Ampere';
AO.qe1.Monitor.PhysicsUnits = 'meter^-2';
AO.qe1.Setpoint.MemberOf      = {'MachineConfig'};
AO.qe1.Setpoint.Mode          = 'Simulator';
AO.qe1.Setpoint.DataType      = 'Scalar';
AO.qe1.Setpoint.ChannelNames = getname(AO.qe1.FamilyName, 'Setpoint', AO.qe1.DeviceList);
AO.qe1.Setpoint.Units         = 'Hardware';
AO.qe1.Setpoint.HWUnits       = 'Ampere';
AO.qe1.Setpoint.PhysicsUnits  = 'meter^-2';
AO.qe1.Setpoint.Range         = [0 225];
AO.qe1.Setpoint.Tolerance     = 0.2;
AO.qe1.Setpoint.DeltaRespMat  = 0.5; 


AO.qe2.FamilyName  = 'qe2';
AO.qe2.MemberOf    = {'PlotFamily'; 'qe2'; 'QUAD'; 'Magnet';};
AO.qe2.DeviceList  = getDeviceList(1,1);
AO.qe2.ElementList = (1:size(AO.qe2.DeviceList,1))';
AO.qe2.Status      = ones(size(AO.qe2.DeviceList,1),1);
AO.qe2.Position    = [];
AO.qe2.Monitor.MemberOf = {};
AO.qe2.Monitor.Mode = 'Simulator';
AO.qe2.Monitor.DataType = 'Scalar';
AO.qe2.Monitor.Units        = 'Hardware';
AO.qe2.Monitor.HWUnits      = 'Ampere';
AO.qe2.Monitor.PhysicsUnits = 'meter^-2';
AO.qe2.Setpoint.MemberOf      = {'MachineConfig'};
AO.qe2.Setpoint.Mode          = 'Simulator';
AO.qe2.Setpoint.DataType      = 'Scalar';
AO.qe2.Setpoint.ChannelNames = getname(AO.qe2.FamilyName, 'Setpoint', AO.qe2.DeviceList);
AO.qe2.Setpoint.Units         = 'Hardware';
AO.qe2.Setpoint.HWUnits       = 'Ampere';
AO.qe2.Setpoint.PhysicsUnits  = 'meter^-2';
AO.qe2.Setpoint.Range         = [0 225];
AO.qe2.Setpoint.Tolerance     = 0.2;
AO.qe2.Setpoint.DeltaRespMat  = 0.5; 
