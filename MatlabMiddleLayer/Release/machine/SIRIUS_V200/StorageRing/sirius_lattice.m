...
elseif strcmpi(mode, 'AC10')
    mode_version = 'AC10_2'; % usado em 'set_magnet_strengths_AC10
...
%% transport lines
dispi  = [girderB1, b1, girderB1, ...
          girderC1, lcor, cv, lc11, ch, lcor, mon, lbpm, sd1, lc12, qf1, lq1, mon, lq2, sf1, lq, qf2, lc21, sd2, lcor, ch, lc22, girderC1, ...
          girderB2, b2, girderB2, ...
          girderC2, lcor, cv, lc31, mon, lbpm, sd3, lc32, qf3, lq1, lq2, sf2, lq, qf4, lcor, ch, lc4, girderC2, ...
          girderB3, b3, lb, mon, lbpm, bce ];
     
dispc  = [ bcs, lbpm, lb, b3, girderB3, ...
           girderC2, lc4, ch, lcor, qf4, lq, sf2, lq2, lq1, qf3, lc32, sd3, lbpm, mon, lc31, cv, lcor, girderC2, ...
           girderB2, b2, girderB2, ...
           girderC1, lc22, ch, lcor, sd2, lc21, qf2, lq, sf1, lq2, mon, lq1, qf1, lc12, sd1, lbpm, mon, lcor, ch, lc11, cv, lcor, girderC1, ...
           girderB1, b1, girderB1];
     
insa   = [lia2, girderA, mon, lbpm, cv, lcor, sa2, lia1, qaf, l2, ch, l2, qad, l12, sa1, l11, girderA];
insb   = [lib,  girderB, mon, lbpm, qbd2, l32, cv, lcor, sb2, l31, qbf, l2, ch, l2, qbd1, l12, sb1, l11, girderB];
