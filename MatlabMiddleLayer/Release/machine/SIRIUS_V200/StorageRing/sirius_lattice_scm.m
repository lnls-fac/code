function r = sirius_lattice_scm(varargin)
% 2012-08-28 Nova rede - Ximenes.
% 2012-10-29 Modificação para incluir corretores skew fora dos sextupolos.
%   Afonso
...
lia2     = drift('lia2', 3.249200, 'DriftPass');
...
ls11     = drift('ls11', 0.040000, 'DriftPass');
ls21     = drift('ls21', 0.075000, 'DriftPass');
ls31     = drift('ls31', 0.090000, 'DriftPass');
ls32     = drift('ls32', 0.060000, 'DriftPass');
ls41     = drift('ls41', 0.090000, 'DriftPass');
ls42     = drift('ls42', 0.380000, 'DriftPass');
ls51     = drift('ls51', 0.090000, 'DriftPass');
ls52     = drift('ls52', 0.100000, 'DriftPass');
