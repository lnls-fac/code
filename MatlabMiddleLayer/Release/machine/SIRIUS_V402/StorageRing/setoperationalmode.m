...
AD = getad;
AD.Machine             = 'SIRIUS_V402';  % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V402_AC20';
AD.Energy              = 3.0;
...
AD.Coupling            = 0.010;
AD.OpsData.PrsProfFile = 'sirius_V402_pressure_profile.txt';
