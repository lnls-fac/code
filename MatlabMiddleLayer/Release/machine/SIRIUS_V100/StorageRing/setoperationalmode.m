...
AD = getad;
AD.Machine             = 'SIRIUS_V100';           % Will already be defined if setpathmml was used
AD.SubMachine          = 'StorageRing';  % Will already be defined if setpathmml was used
AD.OperationalMode     = 'V100_AC20';
AD.Energy              = 3.0;
...
AD.Coupling            = 0.005;
AD.OpsData.PrsProfFile = 'sirius_v100_pressure_profile.txt';
