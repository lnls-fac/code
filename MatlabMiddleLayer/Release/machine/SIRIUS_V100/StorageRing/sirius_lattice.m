...
%% transport lines
disp1  = [lcor, cv, lc11, ch, lcor, sd1, lc12, qf1, lq1, mon, lq2, sf1, lq, qf2, lc21, sd2, lcor, ch, lc22];
disp2  = [lcor, cv, lc31, sd3, lc32, qf3, lq1, mon, lq2, sf2, lq, qf4, lcor, ch, lc4, cv, lcor];

dispi  = [b1, disp1, b2, disp2, b3, lb, mon, lbpm, bce, mc];
dispc  = [mc, bcs, lbpm, lb, b3, fliplr(disp2), b2, fliplr(disp1), b1];
