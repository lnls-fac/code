...
AO.B.DeviceList  = getDeviceList(2,24);
...
AO.B.Monitor.ChannelNames = sirius3_booster_getname(AO.B.FamilyName, 'Monitor', AO.B.DeviceList);
...
AO.B.Setpoint.ChannelNames = sirius3_booster_getname(AO.B.FamilyName, 'Setpoint', AO.B.DeviceList);
...
AO.HCM.DeviceList  = getDeviceList(2,14);
...
AO.VCM.DeviceList  = getDeviceList(2,6);
...
AO.BPMx.DeviceList  = getDeviceList(2,14);
...
AO.BPMy.DeviceList  = getDeviceList(2,14);
