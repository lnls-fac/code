...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin < 1
    [ModeNumber, OKFlag] = listdlg('Name','SIRIUS3','PromptString','Select the Operational Mode:', 'SelectionMode','single', 'ListString', ModeCell);
    if OKFlag ~= 1
...
AD = getad;
AD.Machine             = 'SIRIUS3';           % Will already be defined if setpathmml was used
...
AD.TuneDelay           = 3.0;  
AD.ATModel             = 'sirius3_booster_lattice';
