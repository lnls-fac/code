function r = sirius_lattice(varargin)
% r = sirius_lattice       : retorna o modelo atual do anel;
%
% r = sirius_lattice(mode) : Ateh o momento, pode ser 'AC10'(default) or 'AC20'.
%
% r = sirius_lattice(mode,mode_version): mode_version define o ponto de operacao 
%      e a otimizacao sextupolar a ser usada. Exemplos: 'AC10_1', 'AC10_2',
%      'AC10_5'(default)...
%r = sirius_lattice(mode,mode_version, energy): energia em eV;
%
...
fprintf(['   Loading lattice SIRIUS_V01 - ' mode version ' - ' num2str(energy/1e9) ' GeV' '\n']);
...
cline1a = [ d32, cv,  d12, ch,  d15, sd1a, d17, qf1, d12, mon, d11, sf1a, d20, qf2, d17, sd2a, d12, ch, d10, mon, d10];
cline2a = [ d18, cv,  d26, sd3a, d17, qf3, d12, mon, d11, sf2a, d20, qf4, d15, ch,  crhv, d12, mon, d44];
cline3a = [ d44, mon, d12, ch,  d15, qf4, d20, sf2a, d11, mon, d12, qf3, d17, sd3a, d26, cv, crhv, d18];
cline4a = [ d20, ch,  d12, sd2a, d17, qf2, d20, sf1a, d11, mon, d12, qf1, d17, sd1a, d15, ch,  d12, cv, d22, mon, d10];

cline1b = [ d32, cv,  d12, ch,  d15, sd1b, d17, qf1, d12, mon, d11, sf1b, d20, qf2, d17, sd2b, d12, ch, d10, mon, d10];
cline2b = [ d18, cv,  d26, sd3b, d17, qf3, d12, mon, d11, sf2b, d20, qf4, d15, ch,  crhv, d12, mon, d44];
cline3b = [ d44, mon, d12, ch,  d15, qf4, d20, sf2b, d11, mon, d12, qf3, d17, sd3b, d26, cv, crhv, d18];
cline4b = [ d20, ch,  d12, sd2b, d17, qf2, d20, sf1b, d11, mon, d12, qf1, d17, sd1b, d15, ch,  d12, cv, d22, mon, d10];
