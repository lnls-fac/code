...
fprintf(['   Loading lattice SIRIUS_V310 - ' mode ' - ' num2str(energy/1e9) ' GeV' '\n']);
...
elseif strcmpi(mode, 'AC10')
    mode_version = 'AC10_3'; % usado em 'set_magnet_strengths_AC10
...
d40      = drift('d40', 0.400000, 'DriftPass');
...
%% transport lines
dispi  = [ b1, d30, d09, cv, ch, d20, sd1, d08, omon, d09, qf1, dq, mon, dq, ...
          sf1, dq, dq, qf2, d17, sd2, d15, ch, d07, mon, d10, b2, d15, cv, d20, ...
          d09, sd3, d08, omon, d09, qf3, dq, mon, dq, sf2, dq, dq, qf4, d15, ch, d40, ...
          d06, mon, d10, b3, d08, omon, d05, bce ];
      
dispc  = [ bcs, d10, d03, b3, d50, d06, ch, d15, qf4, dq, dq, sf2, dq, mon, ...
          dq, qf3, d17, sd3, d20, d09, cv, d15, b2, d17, ch, d15, ...
          sd2, d17, qf2, dq, dq, sf1, dq, mon, dq, qf1, d17, sd1, d10, omon, ...
          d10, ch, cv, d20, d09, mon, d10, b1 ];
      
insa   = [ dia, mon, d10, cv, d15, sa2, d17, qaf, d10, d02, ch, d10, ...
          d01, qad, d17, sa1, d07, mon, d10 ];
      
rinsa   = [ dia, mon, d10, cv, d15, sa2, d17, qaf, d10, d02, ch, d10, ...
          d01, qad, d17, sa1, d07, d10 ];
      
insb   = [ dib, mon, d10, qbd2, d20, d08, cv, d15, sb2, d17, qbf, d10, ...
          d01, ch, d10, d02, qbd1, d17, sb1, d07, mon, d10 ];

rinsb   = [ dib, mon, d10, qbd2, d20, d08, cv, d15, sb2, d17, qbf, d10, ...
          d01, ch, d10, d02, qbd1, d17, sb1, d07, d10 ];
      
hsupia = [insa, dispi];
hsupca = [dispc, fliplr(rinsa)];
hsupib = [insb, dispi];
hsupcb = [dispc, fliplr(rinsb)];
