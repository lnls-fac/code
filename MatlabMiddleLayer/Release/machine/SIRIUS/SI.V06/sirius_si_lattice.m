...
% 2015-02-13: novos comprimentos de quadrupolos
...
d170 = drift('d170',  0.170000, 'DriftPass');
...
tc3  = [d130, BC, d130]; % arc sector between B3-B3 (including BC dipole)
tc1a = [girder, d450, ch, cv, d160, sd1, d170, qf1, d130, mon, d130, sf1, d230, qf2, d170, sd2, d120, ch, d100, mon, d120, girder];   % arc sector in between B1-B2
tc2a = [girder, d300, cv, d160, sd3, d170, qf3, d130, mon, d130, sf2, d230, qf4, d170, ch, crhv, d440, mon, d120, girder];          % arc sector in between B2-B3
tc4a = [girder, d560, ch, d170, qf4, d230, sf3, d130, mon, d130, qf3, d170, sd4, d160, cv, crhv, d300, girder];                     % arc sector in between B3-B2
tc5a = [girder, d220, ch, d120, sd5, d170, qf2, d230, sf4, d130, mon, d130, qf1, d170, sd6, d160, ch, cv, d330, mon, d120, girder]; % arc sector in between B2-B1

tc1b = [girder, d450, ch, cv, d160, sd6, d170, qf1, d130, mon, d130, sf4, d230, qf2, d170, sd5, d120, ch, d100, mon, d120, girder]; % arc sector in between B1-B2
tc2b = [girder, d300, cv, d160, sd4, d170, qf3, d130, mon, d130, sf3, d230, qf4, d170, ch, crhv, d440, mon, d120, girder];          % arc sector in between B2-B3
tc4b = [girder, d560, ch, d170, qf4, d230, sf2, d130, mon, d130, qf3, d170, sd3, d160, cv, crhv, d300, girder];                     % arc sector in between B3-B2
tc5b = [girder, d220, ch, d120, sd2, d170, qf2, d230, sf1, d130, mon, d130, qf1, d170, sd1, d160, ch, cv, d330, mon, d120, girder]; % arc sector in between B2-B1
