...
idx_dws = idx_pos+1; while any(strcmpi(the_ring0{idx_dws}.PassMethod, {'IdentityPass', 'DriftPass'})), idx_dws = idx_dws + 1; end;
idx_ups = idx_pos-1; while any(strcmpi(the_ring0{idx_ups}.PassMethod, {'IdentityPass', 'DriftPass'})), idx_ups = idx_ups - 1; end;
...
function [posx posy kickx kicky id_length] = read_kickmap_file(file_name)
