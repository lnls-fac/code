...
config.traj_rk_nrpts         = 5001         # [mm]  step in s for the 4th-order RK integration
...
config.multipoles_fitting_monomials  = (1,3,5,7,9,11) # monomials to include in the polynomial fit of multipoles 
