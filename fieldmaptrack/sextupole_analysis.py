...
def multipoles_analysis(config):
    ...
    config.multipoles.calc_multipoles_integrals_relative(config.multipoles.normal_multipoles_integral, main_monomial = 2, r0 = config.multipoles_r0, is_skew = False)
