...
config.multipoles_perpendicular_grid = np.linspace(-6,6,31) # grid of points on perpendicular line to ref trajectory [mm]
config.multipoles_fitting_monomials  = (0,1,2,3,4,5,6)      # monomials to include in the polynomial fit of multipoles 
