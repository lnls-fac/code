...
class MyForm(QtGui.QMainWindow):
  ...
  def ang_calc(self):
    ...
    if self.count_file == self.n_file - 1:
      ...
      # criando curva de excitacao
      ax7.errorbar(self.corr_alim_princ_arr, self.ang_arr, marker='o', color='r', linewidth=2.0, xerr=self.corr_alim_princ_arr_std, yerr=self.ang_arr_std, ecolor='b', elinewidth=1.0)
