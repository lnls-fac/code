...
global n_file, count_file, r0, rcb, fig1, fig2, fig3, fig4, fig5, fig6, sim_data, spec_data, spec_data_std, width, B_excit, B_excit_std, B_excit_ajust,\
       corr_alim_princ_arr, corr_alim_princ_arr_std, sim_data_multi, ind, ind2, bottom_limit_array, bottom_limit, B_excit_ajust, name_fig, fig7, sim_corr_sat, sim_data_sat
