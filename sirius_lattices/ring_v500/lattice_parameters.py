...
class Mode:
    ...
    def __init__(self, mode_version):
        
        if mode_version.upper() == 'AC10_4':
            ...
            # --- QUADRUPOLES ---    
            self.qaf_strength       =  2.53733156985179;
            self.qad_strength       = -2.729928269122092;
            self.qbd2_strength      = -3.960473342625189;
            self.qbf_strength       =  3.902662679038675;
            self.qbd1_strength      = -2.9676529175558;
            self.qf1_strength       =  2.368979188452946;
            self.qf2_strength       =  3.354162681362089;
            self.qf3_strength       =  3.080099756299886;
            self.qf4_strength       =  2.708484971587339;
            '''SEXTUPOLES'''
            self.sa1_strength       = -123.1722496509632/2;
            self.sa2_strength       =   49.93065558027325/2;
            self.sb1_strength       = -221.8397738651525/2;
            self.sb2_strength       =  114.7544273034517/2;
            self.sd1_strength       = -346.6761204672601/2;
            self.sf1_strength       =  374.2717343204316/2;
            self.self.sd2_strength       = -129.7749377447802/2;
            self.sd3_strength       = -278.7913650216647/2;
            self.sf2_strength       =  317.433316097233/2;
        
        elif mode_version.upper() == 'AC10_5':
            ...
            # --- QUADRUPOLES ---
            self.qaf_strength       =  2.536876;
            self.qad_strength       = -2.730416;
            self.qbd2_strength      = -3.961194;
            self.qbf_strength       =  3.902838;
            self.qbd1_strength      = -2.966239;
            self.qf1_strength       =  2.367821;
            self.qf2_strength       =  3.354286;
            self.qf3_strength       =  3.080632;
            self.qf4_strength       =  2.707639;
            
            '''SEXTUPOLES'''
            self.sa1_strength       = -115.7829759411277/2;
            self.sa2_strength       =   49.50386128829739/2;
            self.sb1_strength       = -214.5386552515188/2;
            self.sb2_strength       =  133.1252391065637/2;
            self.sd1_strength       = -302.6188062085843/2;
            self.sf1_strength       =  369.5045185071228/2;
            self.sd2_strength       = -164.3042864671946/2;
            self.sd3_strength       = -289.9270429064217/2;
            self.sf2_strength       =  333.7039740852999/2;
        
            
        elif mode_version.upper() == 'AC10_6':
            ''' 
            ...
            '''SEXTUPOLES'''
            self.sa1_strength       =   -64.5501;
            self.sa2_strength       =    28.5005;
            self.sb1_strength       =  -113.8315;
            self.sb2_strength       =    64.6216;
            self.sd2_strength       =   -76.9782;
            self.sd3_strength       =  -142.3458;
            self.sf2_strength       =   154.1521;
            self.sd1_strength       =  -161.1970;
            self.sf1_strength       =   190.8217; 
            
        elif mode_version.upper() == 'TEST_INJECT_4K':
            pass
        ...
        elif mode_version.upper() == 'TEST_INJECT_PMM':
            ...
            raise Exception('Mode_version not implemented')
