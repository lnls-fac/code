...
def create_lattice(mode = 'AC10_5', energy = 3e9):
    ...
    #dia      = drift(fam_name = 'dia', length = 3.269200 + 3.65e-3, pass_method = drif_pass_method)
    dia1     = drift(fam_name = 'dia', length = id_length/2, pass_method = drif_pass_method)
    dia2     = drift(fam_name = 'dia', length = 3.26920 + 3.65e-3 - id_length/2, pass_method = drif_pass_method)
    #dib      = drift(fam_name = 'dib', length = 2.909200 + 3.65e-3, pass_method = drif_pass_method)
    dib1     = drift(fam_name = 'dib', length = id_length/2, pass_method = drif_pass_method)
    dib2     = drift(fam_name = 'dib', length = 2.909200 + 3.65e-3 - id_length/2, pass_method = drif_pass_method)
    ...
    qbf      = quadrupole(fam_name = 'qbf',  length = 0.340000, k = mode.qbf_strength,  pass_method = quad_pass_method)
    qbd1     = quadrupole(fam_name = 'qbd1', length = 0.140000, k = mode.qbd1_strength, pass_method = quad_pass_method)
    qf1      = quadrupole(fam_name = 'qf1',  length = 0.250000, k = mode.qf1_strength,  pass_method = quad_pass_method)
    qf2      = quadrupole(fam_name = 'qf2',  length = 0.250000, k = mode.qf2_strength,  pass_method = quad_pass_method)
    ...
    sb2      = sextupole(fam_name = 'sb2', length = 0.150000, s = mode.sb2_strength, pass_method = sext_pass_method)
    sd1      = sextupole(fam_name = 'sd1', length = 0.150000, s = mode.sd1_strength, pass_method = sext_pass_method)
    sf1      = sextupole(fam_name = 'sf1', length = 0.150000, s = mode.sf1_strength, pass_method = sext_pass_method)
    sd2      = sextupole(fam_name = 'sd2', length = 0.150000, s = mode.sd2_strength, pass_method = sext_pass_method)
    ...
    for idx in rf_idx:
        the_ring[idx].frequency = rev_freq * lattice_parameters.harmonic_number
