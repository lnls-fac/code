...
parameter_list = [
  ...
  Parameter(
    ...
    revision = '2014-08-01',
    deps     = ['Storage ring length of B1 dipoles',
                'Storage ring dipole low field bending radius'],
    obs      = ['<math>\thea_\text{B1} = \frac{L_\text{B1}}{\rho_text{LOW}}</math>'],
  ),
  ...
  Parameter(
    ...
    units    = unicode('°',encoding='utf-8'),
    revision = '2014-08-01',
    deps     = ['Storage ring length of B2 dipoles',
                'Storage ring dipole low field bending radius'],
    obs      = ['<math>\thea_\text{B2} = \frac{L_\text{B2}}{\rho_text{LOW}}</math>'],
  ),
  ...
  Parameter(
    ...
    units    = unicode('°',encoding='utf-8'),
    revision = '2014-08-01',
    deps     = ['Storage ring length of B3 dipoles',
                'Storage ring dipole low field bending radius'],
    obs      = ['<math>\thea_\text{B3} = \frac{L_\text{B3}}{\rho_text{LOW}}</math>'],
  ),
  ...
  Parameter(
    ...
    units    = unicode('°',encoding='utf-8'),
    revision = '2014-08-01',
    deps     = ['Storage ring length of BC dipoles',
                'Storage ring dipole high field bending radius'],
    obs      = ['<math>\thea_\text{BC} = \frac{L_\text{BC}}{\rho_text{HIGH}}</math>'],
  ),
  ...
  Parameter(
    ...
    symbol   = r'<math>J_{\tex{y}}</math>',
    units    = '',
    revision = '2014-08-01',
    deps     = [],
    obs      = [r'<math>J_{\tex{y}} = 1 - \frac{I_{\text{4}}{I_{\text{2}} \equiv 1</math>',
                'Vertical damping partition number is identically one for error-free machines for which vertical dispersion functions are zero everywhere.'],
  ),
  ...
  Parameter(
    ...
    symbol   = r'<math>J_{\tex{s}}</math>',
    units    = '',
    revision = '2014-08-01',
    deps     = [],
    obs      = [r'<math>J_{\tex{s}} = 2 + \frac{I_{\text{4}}{I_{\text{2}}}</math>',
                'Vertical damping partition number from dipoles is identically one for error-free machines for which vertical dispersion functions are zero everywhere.'],
  ),
  ...
  Parameter(
    ...
    symbol   = r'<math>f_{\text{s},\text{DIP}}</math>',
    units    = 'kHz',
    revision = '2014-08-01',
    deps     = ['Storage ring revolution frequency',
                'Storage ring synchrotron tune from dipoles'],
    obs      = [r'<math>f_{\text{s},\text{DIP}} = f_\text{rev} \nu_{\text{s},\text{DIP}}</math>'],
  ),  
  ...
  Parameter(
    ...
    symbol   = r'<math>f_{\text{s}}</math>',
    units    = 'kHz',
    revision = '2014-08-01',
    deps     = ['Storage ring revolution frequency',
                'Storage ring synchrotron tune'],
    obs      = [r'<math>f_{\text{s}} = f_\text{rev} \nu_{\text{s}}</math>'],
  ),  
  ...
  Parameter(
    ...
    symbol   = r'<math>\sigma_{\text{s},\text{DIP}}</math>',
    units    = 'mm',
    revision = '2014-08-01',
    deps     = ['Storage ring slip phase from dipoles',
                'Storage ring energy spread from dipoles',
                'Storage ring synchrotron frequency'],
    obs      = [r'<math>\sigma_{\text{s},\text{DIP}} = \frac{c|\eta_{\text{1},\text{DIP}}|\sigma_{\delta,\text{DIP}}}{f_{\text{s},\text{DIP}}}</math>'],
  ),
  ...
  Parameter(
    ...
    symbol   = r'<math>\sigma_{\text{s}}</math>',
    units    = 'mm',
    revision = '2014-08-01',
    deps     = ['Storage ring slip phase',
                'Storage ring energy spread',
                'Storage ring synchrotron frequency'],
    obs      = [r'<math>\sigma_{\text{s},\text{DIP}} = \frac{c|\eta_{\text{1},\text{DIP}}|\sigma_{\delta}{f_{\text{s}}</math>'],
  ),
  ...
  Parameter(
    ...
    symbol   = r'<math>\sigma_{\text{t},\text{DIP}}</math>',
    units    = 'ps',
    revision = '2014-08-01',
    deps     = ['Storage ring natural bunch length from dipoles',
                'Storage ring beam beta factor'],
    obs      = [r'<math>\sigma_{\text{t},\text{DIP}} = \frac{\sigma_{\text{s},\text{DIP}}}{c}</math>'],
  ),
  ...
  Parameter(
    ...
    group    = 'FAC',
    value    = Prms.sr_natural_bunch_duration_from_dipoles,
    symbol   = r'<math>\sigma_{\text{t}}</math>',
    units    = 'ps',
    revision = '2014-08-01',
    deps     = ['Storage ring natural bunch length',
                'Storage ring beam beta factor'],
    obs      = [r'<math>\sigma_{\text{t}} = \frac{\sigma_{\text{s}}{c}</math>'],
  ),
