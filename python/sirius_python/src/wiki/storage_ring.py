...
parameter_list = [
  ...
  Parameter(
    ...
    symbol   = '<math>(B\\rho) = \\frac{p}{ec} = \\frac{E}{ec^2}</math>',
    units    = 'T.m', 
    revision = '2014-08-01',
    deps     = ['Storage ring ebeam energy']
  ),
  ...
  Parameter(
    ...
    symbol   = '<math>N_{SUPERCELLS}</math>',
    units    = '', 
    revision = '2014-08-01',
    deps     = [],
  ),
  ...
  Parameter(name = 'Storage ring radiation integral I1 from dipoles', 
    ...
    symbol   = '<math>I_{1,DIP} = \\oint{\\frac{\\eta_x}{\\rho_x} ds}</math>',
    units    = 'm', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I2 from dipoles', 
    ...
    symbol   = '<math>I_{2,DIP} = \\oint{\\frac{1}{\\rho_x^2} ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I3 from dipoles', 
    ...
    symbol   = '<math>I_{3,DIP} = \\oint{\\frac{1}{|\\rho_x|^3} ds}</math>',
    units    = '1/m^2', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version'],
  ), 
  ...
  Parameter(name = 'Storage ring radiation integral I4 from dipoles', 
    ...
    symbol   = '<math>I_{4,DIP} = \\frac{\\eta_x(s_0) \\tan \\theta(s_0)}{\\rho_x^2} + \oint{\\frac{\\eta_x}{\\rho_x^3} \\left(1 + 2 \\rho_x^2 k\\right) ds} + \\frac{\\eta_x(s_1) \\tan \\theta(s_1)}{\\rho_x^2}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version'],
  ),   
  ...
  Parameter(name = 'Storage ring radiation integral I5 from dipoles', 
    ...
    symbol   = '<math>I_{5,DIP} = \\oint{\\frac{H_x}{|\\rho_x|^3} ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version', 'Storage ring optics mode'],
  ),  
  ...
  Parameter(name = 'Storage ring radiation integral I6 from dipoles', 
    ...
    symbol   = '<math>I_{6,DIP} = \\oint{k^2 \\eta_x^2 ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version', 'Storage ring optics mode'],
  ),            
  ...
  Parameter(name = 'Storage ring radiation integral I1 from IDs', 
    ...
    symbol   = '<math>I_{1,IDs} = \\oint{\\frac{\\eta_x}{\\rho_x} ds}</math>',
    units    = 'm', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version', 'Storage ring optics mode'],
  ), 
  ...
  Parameter(name = 'Storage ring radiation integral I2 from IDs', 
    ...
    symbol   = '<math>I_{2,IDs} = \\oint{\\frac{1}{\\rho_x^2} ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version'],
  ), 
  ...
  Parameter(name = 'Storage ring radiation integral I3 from IDs', 
    ...
    symbol   = '<math>I_{3,IDs} = \\oint{\\frac{1}{|\\rho_x|^3} ds}</math>',
    units    = '1/m^2', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version'],
  ), 
  ...
  Parameter(name = 'Storage ring radiation integral I4 from IDs', 
    ...
    symbol   = '<math>I_{4,IDs} = \\frac{\\eta_x(s_0) \\tan \\theta(s_0)}{\\rho_x^2} + \oint{\\frac{\\eta_x}{\\rho_x^3} \\left(1 + 2 \\rho_x^2 k\\right) ds} + \\frac{\\eta_x(s_1) \\tan \\theta(s_1)}{\\rho_x^2}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version'],
  ),   
  ...
  Parameter(name = 'Storage ring radiation integral I5 from IDs', 
    ...
    symbol   = '<math>I_{5,IDs} = \\oint{\\frac{H_x}{|\\rho_x|^3} ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version', 'Storage ring optics mode'],
  ),  
  ...
  Parameter(name = 'Storage ring radiation integral I6 from IDs', 
    ...
    symbol   = '<math>I_{6,IDs} = \\oint{k^2 \\eta_x^2 ds}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
    deps     = ['Storage ring magnetic rigidity', 'Storage ring lattice version', 'Storage ring optics mode'],
  ),                 
  ...
  Parameter(name = 'Storage ring radiation integral I1', 
    ...
    symbol   = '<math>I_{1} = I_{1,DIP} + I_{1,IDs}</math>',
    units    = 'm', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I2', 
    ...
    symbol   = '<math>I_{2} = I_{2,DIP} + I_{2,IDs}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I3', 
    ...
    symbol   = '<math>I_{3} = I_{3,DIP} + I_{3,IDs}</math>',
    units    = '1/m^2', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I4', 
    ...
    symbol   = '<math>I_{4} = I_{4,DIP} + I_{4,IDs}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I5', 
    ...
    symbol   = '<math>I_{5} = I_{5,DIP} + I_{5,IDs}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
  ...
  Parameter(name = 'Storage ring radiation integral I6', 
    ...
    symbol   = '<math>I_{6} = I_{6,DIP} + I_{6,IDs}</math>',
    units    = '1/m', 
    revision = '2014-08-01',
