...
class PassMethods:
    ...
    def _global_2_local(pos, element):
        try:
            _translate_pos(pos, element.t_in)
        except:
            pass
        try:
            _rotate_pos(pos, element.r_in)
        except:
            pass
    ...
    def _local_2_global(pos, element):
        try:
            _rotate_pos(pos, element.r_out)
        except:
            pass
        try:
            _translate_pos(pos, element.t_out)
        except:
            pass
    ...
    dict = { identity_pass              : ('identity_pass',              PassMethods.identity_pass) ,
