...
#folder = '/home/ximenes/Desktop/TESTES-BOBINA/BQF03 - Curva Excitacao/Fonte 130A/Ligacao_Desfocalizador/01_Sequencia'
#analysis.booster.quadrupoles_excitation(folder = folder, plot_label = 'QUADRUPOLES', harmonics = analysis.booster.default_quad_harmonics, ymin_multipoles = 1e-6, ymin_skew_angle = 1e-2, plot_normal_multipoles_flag = True, plot_skew_multipoles_flag = True, plot_skew_angle_flag = True)
