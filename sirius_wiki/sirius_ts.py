...
parameter_list = [
  ...
  Parameter(name='TS lattice length', group='FAC', is_derived=False, value=Prms.ts_lattice_length, symbol=r'<math>L</math>', units='m', deps=[], obs=['Includes septum.'], ),

  Parameter(name='TS magnet dipole number', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_number, symbol=r'<math>N_\text{DIP}</math>', units='', deps=[], obs=[], ),
  Parameter(name='TS magnet quadrupole number', group='FAC', is_derived=False, value=Prms.ts_magnet_quadrupole_number, symbol=r'<math>N_\text{QUAD}</math>', units='', deps=[], obs=[], ),
  Parameter(name='TS magnet quadrupole maximum gradient', group='FAC', is_derived=False, value=Prms.ts_magnet_quadrupole_maximum_gradient, symbol=r"<math>B'_\text{max}</math>", units='T/m', deps=[], obs=[], ),
  Parameter(name='TS magnet dipole hardedge length', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_hardedge_length, symbol=r'<math>L_\text{DIP}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='TS magnet septum hardedge length', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_hardedge_length, symbol=r'<math>L_\text{sep,ext}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='TS magnet thick injection septum hardedge length', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_hardedge_length, symbol=r'<math>L_\text{thick sep,inj}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='TS magnet thin injection septum hardedge length', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_hardedge_length, symbol=r'<math>L_\text{thin sep,inj}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='TS magnet dipole deflection angle', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_deflection_angle, symbol=r'<math>\theta_\text{DIP}</math>', units=unicode('°',encoding='utf-8'), deps=[], obs=[], ),
  Parameter(name='TS magnet extraction septum deflection angle', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_deflection_angle, symbol=r'<math>\theta_\text{sep,ext}</math>', units=unicode('°',encoding='utf-8'), deps=[], obs=[], ),
  Parameter(name='TS magnet thick injection septum deflection angle', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_deflection_angle, symbol=r'<math>\theta_\text{thick sep,inj}</math>', units=unicode('°',encoding='utf-8'), deps=[], obs=[], ),
  Parameter(name='TS magnet thin injection septum deflection angle', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_deflection_angle, symbol=r'<math>\theta_\text{thin sep,inj}</math>', units=unicode('°',encoding='utf-8'), deps=[], obs=[], ),
  Parameter(name='TS magnet dipole hardedge bending radius', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_bending_radius, symbol=r'<math>\rho_\text{DIP}</math>', units='m', deps=['TS hardedge length of dipoles',        'TS deflection angle of dipoles'],   obs     =[r'<math>\rho_\text{DIP}=\frac{L_\text{DIP}}{\theta_\text{DIP}}</math>'],
  Parameter(name='TS magnet extraction septum hardedge bending angle', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_bending_radius, symbol=r'<math>\rho_\text{sep,ext}</math>', units='m', deps=['TS hardedge length of extraction septum',        'TS deflection angle of extraction septum'],   obs     =[r'<math>\rho_\text{sep,ext}=\frac{L_\text{sep,ext}}{\theta_\text{sep,ext}}</math>'],
  Parameter(name='TS magnet thick injection septum hardedge bending radius', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_bending_radius, symbol=r'<math>\rho_\text{thick sep,inj}</math>', units='m', deps=['TS hardedge length of thick injection septum',        'TS deflection angle of thick injection septum'],   obs     =[r'<math>\rho_\text{thick sep,inj}=\frac{L_\text{thick sep,inj}}{\theta_\text{thick sep,inj}}</math>'],
  Parameter(name='TS magnet thin injection septum hardedge bending radius', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_bending_radius, symbol=r'<math>\rho_\text{thin sep,inj}</math>', units='m', deps=['TS hardedge length of thin injection septum',        'TS deflection angle of thin injection septum'],   obs     =[r'<math>\rho_\text{thin sep,inj}=\frac{L_\text{thin sep,inj}}{\theta_\text{thin sep,inj}}</math>'],
  Parameter(name='TS magnet dipole hardedge magnetic field', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_magnetic_field, symbol=r'<math>B_\text{DIP}</math>', units='T', deps=['TS beam magnetic rigidity',        'TS dipole bending radius'],   obs     =[r'<math>B_\text{DIP}=\frac{(B\rho)}{\rho_\text{DIP}}</math>'],
  Parameter(name='TS magnet extraction septum hardedge magnetic field', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_magnetic_field, symbol=r'<math>B_\text{sep,ext}</math>', units='T', deps=['TS beam magnetic rigidity',        'TS extraction septum bending radius'],   obs     =[r'<math>B_\text{sep,ext}=\frac{(B\rho)}{\rho_\text{sep,ext}}</math>'],
  Parameter(name='TS magnet thick injection septum hardedge magnetic field', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_magnetic_field, symbol=r'<math>B_\text{thick sep,inj}</math>', units='T', deps=['TS beam magnetic rigidity',        'TS thick injection septum bending radius'],   obs     =[r'<math>B_\text{thick sep,inj}=\frac{(B\rho)}{\rho_\text{thick sep,inj}}</math>'],
  Parameter(name='TS magnet thin injection septum hardedge magnetic field', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_magnetic_field, symbol=r'<math>B_\text{thin sep,inj}</math>', units='T', deps=['TS beam magnetic rigidity',        'TS thin injection septum bending radius'],   obs     =[r'<math>B_\text{thin sep,inj}=\frac{(B\rho)}{\rho_\text{thin sep,inj}}</math>'],
  Parameter(name='TS magnet dipole hardedge sagitta', group='FAC', is_derived=False, value=Prms.ts_magnet_dipole_sagitta, symbol=r'<math>S_\text{DIP}</math>', units='mm', deps=[], obs=[], ),
  Parameter(name='TS magnet extraction septum hardedge sagitta', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_sagitta, symbol=r'<math>S_\text{sep,ext}</math>', units='mm', deps=[], obs=[], ),
  Parameter(name='TS magnet thick injection septum hardedge sagitta', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_sagitta, symbol=r'<math>S_\text{thick sep,inj}</math>', units='mm', deps=[], obs=[], ),
  Parameter(name='TS magnet thin injection septum hardedge sagitta', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_sagitta, symbol=r'<math>S_\text{thin sep,inj}</math>', units='mm', deps=[], obs=[], ),
  Parameter(name='TS magnet extraction setpum number', group='FAC', is_derived=False, value=Prms.ts_magnet_extraction_septum_number, symbol=r'<math>N_\text{sep,ext}</math>', units='', deps=[], obs=[], ),
  Parameter(name='TS magnet thick injection septum number', group='FAC', is_derived=False, value=Prms.ts_magnet_thick_injection_septum_number, symbol=r'<math>N_\text{thick sep,inj}</math>', units='', deps=[], obs=[], ),
  Parameter(name='TS magnet thin injection septum number', group='FAC', is_derived=False, value=Prms.ts_magnet_thin_injection_septum_number, symbol=r'<math>N_\text{thin sep,inj}</math>', units='', deps=[], obs=[], ),
