...
parameter_list = [
  ...
  Parameter(name='TB beam gamma factor', group='FAC', is_derived=False, value='gamma(1.0e-3*tb_beam_energy)', symbol=r'<math>\gamma</math>', units='', deps=[], obs=[], ),
  Parameter(name='TB beam beta factor', group='FAC', is_derived=False, value='beta(tb_beam_gamma_factor)', symbol=r'<math>\beta</math>', units='', deps=[], obs=[], ),
  Parameter(name='TB beam velocity', group='FAC', is_derived=False, value='velocity(tb_beam_beta_factor)', symbol=r'<math>v</math>', units='', deps=[], obs=[], ),
  Parameter(name='TB beam magnetic rigidity', group='FAC', is_derived=False, value='brho(1.0e-3*tb_beam_energy, tb_beam_beta_factor)', symbol=r'<math>(B\rho)</math>', units=unicode('T·m', encoding='utf-8'), deps=[], obs=[r'<math>(B\rho)=\frac{p}{ec}=\frac{E}{ec^2}</math>'], ),
  ...
  Parameter(name='TB magnet dipole magnetic field', group='FAC', is_derived=True, value='"TB beam magnetic rigidity"/"TB magnet septum bending radius"', symbol=r'<math>B_\text{sep}</math>', units='T', deps=[],   obs=[r'<math>B_\text{sep}=\frac{(B\rho)}{\rho_\text{sep}}</math>'],
