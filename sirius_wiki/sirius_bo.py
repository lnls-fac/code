...
parameter_list = [
  ...
  Parameter(
    name     = 'Booster systematic normal 6-pole error tolerance for dipoles',
    group    = 'FAC',
    value    = Prms.bo_systematic_normal_6_pole_error_tolerance_for_dipoles,
  ...
  Parameter(
    name     = 'Booster random normal 22-pole error tolerance for sextupoles',
    group    = 'FAC',
    value    = Prms.bo_random_normal_22_pole_error_tolerance_for_sextupoles,
  ...
  Parameter(
    name     = 'Booster random normal 30-pole error tolerance for sextupoles',
    group    = 'FAC',
    value    = Prms.bo_random_normal_30_pole_error_tolerance_for_sextupoles,
