...
parameter_list = [
  ...
  Parameter(name='SI magnet dipole bc number', group='FAC', is_derived=True, value='4*"SI lattice symmetry"', symbol=r'<math>N_\text{bc}</math>', units='', deps=[], obs=[], ),
  ...
  Parameter(name='SI optics natural linear chromaticity horizontal', group='FAC', is_derived=False, value=si_optics_natural_chromaticity_horizontal, symbol=r'<math>\xi_{0, x}</math>', units='', deps=['SI optics mode'], obs=[], ),
  Parameter(name='SI optics linear chromaticity horizontal', group='FAC', is_derived=False, value=si_optics_chromaticity_horizontal, symbol=r'<math>\xi_{x}</math>', units='', deps=['SI optics mode'], obs=[], ),
  Parameter(name='SI optics natural linear chromaticity vertical', group='FAC', is_derived=False, value=si_optics_natural_chromaticity_vertical, symbol=r'<math>\xi_{0, y}</math>', units='', deps=['SI optics mode'], obs=[], ),
  Parameter(name='SI optics linear chromaticity vertical', group='FAC', is_derived=False, value=si_optics_chromaticity_vertical, symbol=r'<math>\xi_{y}</math>', units='', deps=['SI optics mode'], obs=[], ),
  ...
  Parameter(name='SI optics transverse coupling', group='FAC', is_derived=False, value=si_optics_transverse_coupling, symbol=r'<math>\kappa</math>', units='%', deps=['SI optics mode'], obs=[], ),
