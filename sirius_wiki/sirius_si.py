...
parameter_list = [
  ...
  Parameter(name='Storage ring number of SDA sextupoles', group='FAC', value=Prms.si_number_of_SDA_sextupoles, symbol=r'<math>N_\text{SDA}</math>', units='', deps=[], obs=[], ),
  Parameter(name='Storage ring number of SFA sextupoles', group='FAC', value=Prms.si_number_of_SFA_sextupoles, symbol=r'<math>N_\text{SFA}</math>', units='', deps=[], obs=[], ),
  Parameter(name='Storage ring number of SDB sextupoles', group='FAC', value=Prms.si_number_of_SDB_sextupoles, symbol=r'<math>N_\text{SDB}</math>', units='', deps=[], obs=[], ),
  Parameter(name='Storage ring number of SFB sextupoles', group='FAC', value=Prms.si_number_of_SFB_sextupoles, symbol=r'<math>N_\text{SFB}</math>', units='', deps=[], obs=[], ),
  Parameter(name='Storage ring hardedge length of SDA sextupoles', group='FAC', value=Prms.si_hardedge_length_of_SDA_sextupoles, symbol=r'<math>L_\text{SDA}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='Storage ring hardedge length of SFA sextupoles', group='FAC', value=Prms.si_hardedge_length_of_SFA_sextupoles, symbol=r'<math>L_\text{SFA}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='Storage ring hardedge length of SDB sextupoles', group='FAC', value=Prms.si_hardedge_length_of_SDB_sextupoles, symbol=r'<math>L_\text{SDB}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='Storage ring hardedge length of SFB sextupoles', group='FAC', value=Prms.si_hardedge_length_of_SFB_sextupoles, symbol=r'<math>L_\text{SFB}</math>', units='m', deps=[], obs=[], ),
  Parameter(name='Storage ring maximum integrated sextupolar field of SDA sextupoles', group='FAC', value=Prms.si_maximum_integrated_sextupolar_field_of_SDA_sextupoles, symbol=r'<math>(SL)_\text{SDA}</math>', units='T/m', deps=[], obs=[r"<math>\text{(B''L)} \equiv \frac{1}{2} \int{ds\;\frac{\partial^2 B_y}{\partial x^2}}</math>"], ),
  Parameter(name='Storage ring maximum integrated sextupolar field of SFA sextupoles', group='FAC', value=Prms.si_maximum_integrated_sextupolar_field_of_SFA_sextupoles, symbol=r'<math>(SL)_\text{SFA}</math>', units='T/m', deps=[], obs=[r"<math>\text{(B''L)} \equiv \frac{1}{2} \int{ds\;\frac{\partial^2 B_y}{\partial x^2}}</math>"], ),
  Parameter(name='Storage ring maximum integrated sextupolar field of SDB sextupoles', group='FAC', value=Prms.si_maximum_integrated_sextupolar_field_of_SDB_sextupoles, symbol=r'<math>(SL)_\text{SDB}</math>', units='T/m', deps=[], obs=[r"<math>\text{(B''L)} \equiv \frac{1}{2} \int{ds\;\frac{\partial^2 B_y}{\partial x^2}}</math>"], ),
  Parameter(name='Storage ring maximum integrated sextupolar field of SFB sextupoles', group='FAC', value=Prms.si_maximum_integrated_sextupolar_field_of_SFB_sextupoles, symbol=r'<math>(SL)_\text{SFB}</math>', units='T/m', deps=[], obs=[r"<math>\text{(B''L)} \equiv \frac{1}{2} \int{ds\;\frac{\partial^2 B_y}{\partial x^2}}</math>"], ),
  Parameter(name='Storage ring hardedge maximum sextupolar field of SDA sextupoles', group='FAC', value=Prms.si_hardedge_maximum_sextupolar_field_of_SDA_sextupoles, symbol=r"<math>B''_\text{SDA}</math>", units='T.m<sup>-2</sup>', deps=["Storage ring maximum integrated sextupolar field of SDA sextupoles", "Storage ring hardedge length of SDA sextupoles"], obs=[r"<math>B''_\text{SDA} \equiv \frac{(B''L)_\text{SDA}}{L_\text{SDA}}</math>"], ),
  Parameter(name='Storage ring hardedge maximum sextupolar field of SFA sextupoles', group='FAC', value=Prms.si_hardedge_maximum_sextupolar_field_of_SFA_sextupoles, symbol=r"<math>B''_\text{SFA}</math>", units='T.m<sup>-2</sup>', deps=["Storage ring maximum integrated sextupolar field of SFA sextupoles", "Storage ring hardedge length of SFA sextupoles"], obs=[r"<math>B''_\text{SFA} \equiv \frac{(B''L)_\text{SFA}}{L_\text{SFA}}</math>"], ),
  Parameter(name='Storage ring hardedge maximum sextupolar field of SDB sextupoles', group='FAC', value=Prms.si_hardedge_maximum_sextupolar_field_of_SDB_sextupoles, symbol=r"<math>B''_\text{SDB}</math>", units='T.m<sup>-2</sup>', deps=["Storage ring maximum integrated sextupolar field of SDB sextupoles", "Storage ring hardedge length of SDB sextupoles"], obs=[r"<math>B''_\text{SDB} \equiv \frac{(B''L)_\text{SDB}}{L_\text{SDB}}</math>"], ),
  Parameter(name='Storage ring hardedge maximum sextupolar field of SFB sextupoles', group='FAC', value=Prms.si_hardedge_maximum_sextupolar_field_of_SFB_sextupoles, symbol=r"<math>B''_\text{SFB}</math>", units='T.m<sup>-2</sup>', deps=["Storage ring maximum integrated sextupolar field of SFB sextupoles", "Storage ring hardedge length of SFB sextupoles"], obs=[r"<math>B''_\text{SFB} \equiv \frac{(B''L)_\text{SFB}}{L_\text{SFB}}</math>"], ),
  Parameter(name='Storage ring hardedge maximum strength of SDA sextupoles', group='FAC', value=Prms.si_hardedge_maximum_strength_of_SDA_sextupoles, symbol=r'<math>S_\text{SDA}</math>', units='m<sup>-3</sup>', deps=["Storage ring hardedge maximum sextupolar field of SDA sextupoles", "Storage ring beam magnetic rigidity"], obs=[r"<math>S_\text{SDA} \equiv \frac{B''_\text{SDA}}{B\rho}</math>"], ),  
  Parameter(name='Storage ring hardedge maximum strength of SFA sextupoles', group='FAC', value=Prms.si_hardedge_maximum_strength_of_SFA_sextupoles, symbol=r'<math>S_\text{SFA}</math>', units='m<sup>-3</sup>', deps=["Storage ring hardedge maximum sextupolar field of SDA sextupoles", "Storage ring beam magnetic rigidity"], obs=[r"<math>S_\text{SFA} \equiv \frac{B''_\text{SFA}}{B\rho}</math>"], ),  
  Parameter(name='Storage ring hardedge maximum strength of SDB sextupoles', group='FAC', value=Prms.si_hardedge_maximum_strength_of_SDB_sextupoles, symbol=r'<math>S_\text{SDB}</math>', units='m<sup>-3</sup>', deps=["Storage ring hardedge maximum sextupolar field of SDA sextupoles", "Storage ring beam magnetic rigidity"], obs=[r"<math>S_\text{SDB} \equiv \frac{B''_\text{SDB}}{B\rho}</math>"], ),  
  Parameter(name='Storage ring hardedge maximum strength of SFB sextupoles', group='FAC', value=Prms.si_hardedge_maximum_strength_of_SFB_sextupoles, symbol=r'<math>S_\text{SFB}</math>', units='m<sup>-3</sup>', deps=["Storage ring hardedge maximum sextupolar field of SDA sextupoles", "Storage ring beam magnetic rigidity"], obs=[r"<math>S_\text{SFB} \equiv \frac{B''_\text{SFB}}{B\rho}</math>"], ),  
