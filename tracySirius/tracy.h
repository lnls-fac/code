...
#define Cell_nLocMax    8000

// maximum number of families for Elem_NFam
#define Elem_nFamMax    5000 // XRR 2012-04-17
...
#define NameLength      150  // maximum length of identifiers
...
//Adicionei Corr para colocar erros de multipolos em corretoras
enum { All = 0, Dip = 1, Quad = 2, Sext = 3, Oct = 4, Dec = 5, Dodec = 6, Corr = 0 };
...
typedef double svdarray[mnp];
typedef double svdmat[mnp][mnp];
...
extern void EigenVal(double (*Ai)[mnp], long n, double *wr, double *wi);
