...
class Marker(Element):
    ...
    _attributes_to_print = Element._attributes_to_print
...
class Corrector(Element):
    ...
    _attributes_to_print = Element._attributes_to_print + ['hkick',
                                                           'vkick']
...
class Quadrupole(Element):
    ...
    _attributes_to_print = Element._attributes_to_print + ['nr_steps',
                                                           'polynom_a',
                                                           'polynom_b',
                                                           'r_in',
                                                           'r_out',
...
class RBend(Element):
    ...
    _attributes_to_print = Element._attributes_to_print + ['angle',
                                                           'angle_in',
                                                           'angle_out',
                                                           'gap',
                                                           'fint_in',
...
class RFCavity(Element):
    ...
    _attributes_to_print = Element._attributes_to_print + ['frequency',
                                                           'voltage']
